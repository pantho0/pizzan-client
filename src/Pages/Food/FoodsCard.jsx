...
const FoodsCard = ({ food }) => {
    const { foodName, foodImage, foodCategory, price, madeBy, foodOrigin, description, availableQuantity, orderCount } = food;
    return (
        <div class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
            ...
            <div class="p-6">
                ...
                <div className="flex md:flex-row justify-between">
                    <p class="font-sans bg-[#EB0029] inline-block text-white px-1 rounded-lg antialiased font-bold leading-relaxed">
